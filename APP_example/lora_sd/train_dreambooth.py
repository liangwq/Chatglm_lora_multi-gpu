...
def import_model_class_from_model_name_or_path(pretrained_model_name_or_path: str, revision: str,cache_dir_path:str):
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        default=None,
        required=True,
        help="Path to pretrained model or model identifier save to local",
    )
    parser.add_argument(
        "--revision",
        type=str,
...
def main(args):
    ...
    if args.tokenizer_name:
        tokenizer = AutoTokenizer.from_pretrained(args.tokenizer_name, cache_dir = args.cache_dir_path,revision=args.revision, use_fast=False)
    ...
    text_encoder_cls = import_model_class_from_model_name_or_path(args.pretrained_model_name_or_path, args.revision,args.cache_dir_path)
    ...
    text_encoder = text_encoder_cls.from_pretrained(
        args.pretrained_model_name_or_path,cache_dir = args.cache_dir_path, subfolder="text_encoder", revision=args.revision
    )
    vae = AutoencoderKL.from_pretrained(args.pretrained_model_name_or_path, cache_dir = args.cache_dir_path,subfolder="vae", revision=args.revision)
    unet = UNet2DConditionModel.from_pretrained(
        args.pretrained_model_name_or_path, cache_dir = args.cache_dir_path, subfolder="unet", revision=args.revision
    )

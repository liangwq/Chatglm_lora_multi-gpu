...
# 设置一些预设的角色和任务提示
assistant_role_name = "材料设计专家"
user_role_name = "反重力引擎航空器开发商"
task = "整理一份适合反重力引擎发动机外壳的材料设计方案"
...
assistant_agent = CAMELAgent(assistant_sys_msg, ChatOpenAI(temperature=0.2,model="gpt-3.5-turbo-16k"))
user_agent = CAMELAgent(user_sys_msg, ChatOpenAI(temperature=0.2,model="gpt-3.5-turbo-16k"))

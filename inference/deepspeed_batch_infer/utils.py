...
class DSPipeline():
    ...
    def __init__(self,
        ...
        self.tokenizer = AutoTokenizer.from_pretrained("/root/autodl-tmp/GLM-API/model/chatglm3-6b-32k", trust_remote_code=True)#,cache_dir ="/root/autodl-tmp/GLM-API/model")
        #model = AutoModel.from_pretrained("chatglm3-6b-32k", trust_remote_code=True,cache_dir ="./").half().cuda()
